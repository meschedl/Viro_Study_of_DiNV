...
The only way I know how to do this is break up by each day and then combine together 

Right now I have not separated out male and female, in all other analyses there is no difference between them so it should be fine to combine
